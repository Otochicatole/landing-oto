...
/** Map page scroll to orbit-style perspective (same language as black hole OrbitControls). */
export function perspectiveFromScroll(
  ...
  // Horizontal orbit — the main “drag perspective” gesture on the black hole
